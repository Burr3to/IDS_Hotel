...
create or replace procedure showavailablerooms (
   ...
   p_equipmentname in varchar default null
    ...
    noEquipmentName EXCEPTION;
    PRAGMA EXCEPTION_INIT(noEquipmentName, -20006); 
...
begin
    ...
    WHEN noEquipmentName THEN DBMS_OUTPUT.PUT_LINE('No equipment available: ' || p_equipmentName);
