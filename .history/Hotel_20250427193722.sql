...
VALUES (1, 4, 1, TO_DATE('2024-03-01', 'YYYY-MM-DD'), TO_DATE('2024-03-05', 'YYYY-MM-DD'), 2, 'Confirmed', 100.00);
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (2, 5, 1, TO_DATE('2024-03-10', 'YYYY-MM-DD'), TO_DATE('2024-03-15', 'YYYY-MM-DD'), 1, 'Pending', 75.00);
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (3, 4, 1, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-04-07', 'YYYY-MM-DD'), 3, 'Confirmed', 150.00);
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (4, 6, 2, TO_DATE('2024-05-03', 'YYYY-MM-DD'), TO_DATE('2024-08-07', 'YYYY-MM-DD'), 3, 'Confirmed', 300.00);
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (5, 4, 2, TO_DATE('2024-05-02', 'YYYY-MM-DD'), TO_DATE('2024-07-07', 'YYYY-MM-DD'), 3, 'Confirmed', 250.00);
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (13, 10, 8, TO_DATE('2024-06-10', 'YYYY-MM-DD'), TO_DATE('2024-06-15', 'YYYY-MM-DD'), 2, 'Confirmed', 625.00); -- Room 401, customer 10, emp 8
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (14, 11, 1, TO_DATE('2024-07-20', 'YYYY-MM-DD'), TO_DATE('2024-07-22', 'YYYY-MM-DD'), 3, 'Pending', 500.00); -- Room 402, customer 11, emp 1
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (15, 12, 8, TO_DATE('2024-08-05', 'YYYY-MM-DD'), TO_DATE('2024-08-10', 'YYYY-MM-DD'), 2, 'Confirmed', 2750.00); -- Room 403, customer 12, emp 8
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (17, 13, 1, TO_DATE('2024-09-01', 'YYYY-MM-DD'), TO_DATE('2024-09-03', 'YYYY-MM-DD'), 2, 'Confirmed', 2000.00); -- Room 501, customer 13, emp 1
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (18, 4, 2, TO_DATE('2024-09-15', 'YYYY-MM-DD'), TO_DATE('2024-09-20', 'YYYY-MM-DD'), 3, 'Cancelled', 3000.00); -- Room 502, customer 4, emp 2
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (7, 5, 8, TO_DATE('2024-10-01', 'YYYY-MM-DD'), TO_DATE('2024-10-04', 'YYYY-MM-DD'), 2, 'Completed', 750.00); -- Room 202, customer 5, emp 8
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (8, 6, 1, TO_DATE('2024-11-11', 'YYYY-MM-DD'), TO_DATE('2024-11-12', 'YYYY-MM-DD'), 2, 'Confirmed', 500.00); -- Room 203, customer 6, emp 1
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (9, 10, 2, TO_DATE('2024-12-01', 'YYYY-MM-DD'), TO_DATE('2024-12-05', 'YYYY-MM-DD'), 4, 'Confirmed', 2500.00); -- Room 204, customer 10, emp 2
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (19, 11, 8, TO_DATE('2025-01-10', 'YYYY-MM-DD'), TO_DATE('2025-01-15', 'YYYY-MM-DD'), 2, 'Pending', 650.00); -- Room 105, customer 11, emp 8 (Using 2025 dates and new prices)
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (20, 12, 1, TO_DATE('2025-02-20', 'YYYY-MM-DD'), TO_DATE('2025-02-28', 'YYYY-MM-DD'), 4, 'Confirmed', 1440.00); -- Room 205, customer 12, emp 1 (Using 2025 dates and new prices)
INSERT INTO Reservation (id_room, id_person, id_personEmploy, dateFrom, dateTo, numberOfResidents, reservationStatus, price)
VALUES (21, 13, 8, TO_DATE('2025-03-10', 'YYYY-MM-DD'), TO_DATE('2025-03-12', 'YYYY-MM-DD'), 3, 'Completed', 540.00); -- Room 305, customer 13, emp 8 (Using 2025 dates and new prices)

-- Payment
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (1, 100.00, 'Credit Card', TO_DATE('2024-03-05', 'YYYY-MM-DD'));
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (3, 150.00, 'Cash', TO_DATE('2024-04-07', 'YYYY-MM-DD'));
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (6, 625.00, 'Credit Card', TO_DATE('2024-06-15', 'YYYY-MM-DD'));
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (8, 2750.00, 'Bank Transfer', TO_DATE('2024-08-01', 'YYYY-MM-DD')); -- Platba pred príchodom
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (11, 750.00, 'Cash', TO_DATE('2024-10-04', 'YYYY-MM-DD'));
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (12, 500.00, 'Credit Card', TO_DATE('2024-11-12', 'YYYY-MM-DD'));
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (13, 2500.00, 'Credit Card', TO_DATE('2024-12-05', 'YYYY-MM-DD'));
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (15, 1440.00, 'Bank Transfer', TO_DATE('2025-02-18', 'YYYY-MM-DD')); -- Platba pred príchodom
INSERT INTO Payment (id_reser, totalPrice, paymentMethod, paymentDate)
VALUES (16, 540.00, 'Cash', TO_DATE('2025-03-12', 'YYYY-MM-DD'));

-- Price_in_date
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (1, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-4-28', 'YYYY-MM-DD'), 50.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (2, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-4-28', 'YYYY-MM-DD'), 75.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (3, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-4-28', 'YYYY-MM-DD'), 100.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (4, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-4-28', 'YYYY-MM-DD'), 200.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (5, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-4-28', 'YYYY-MM-DD'), 350.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (6, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-4-28', 'YYYY-MM-DD'), 500.00);

INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (1, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-8-28', 'YYYY-MM-DD'), 75.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (2, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-8-28', 'YYYY-MM-DD'), 100.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (3, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-8-28', 'YYYY-MM-DD'), 125.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (4, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-8-28', 'YYYY-MM-DD'), 250.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (5, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-8-28', 'YYYY-MM-DD'), 400.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (6, TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-8-28', 'YYYY-MM-DD'), 600.00);

INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (1, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-12-28', 'YYYY-MM-DD'), 100.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (2, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-12-28', 'YYYY-MM-DD'), 150.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (3, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-12-28', 'YYYY-MM-DD'), 250.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (4, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-12-28', 'YYYY-MM-DD'), 500.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (5, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-12-28', 'YYYY-MM-DD'), 750.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (6, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-12-28', 'YYYY-MM-DD'), 1000.00);

INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (1, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 110.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (2, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 160.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (3, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 270.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (4, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 550.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (5, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 800.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (6, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 1100.00);

INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (1, TO_DATE('2025-05-01', 'YYYY-MM-DD'), TO_DATE('2025-08-31', 'YYYY-MM-DD'), 130.00);
INSERT INTO Price_in_date (id_room_type, dateFrom, dateTo, priceConstant)
VALUES (2, TO_DATE('2025-05-01', 'YYYY-MM-DD'), TO_DATE('2025-08-31', 'YYYY-MM-DD'), 180.00);
...
-- Equipment
INSERT INTO Equipment (equipmentName, equipment_description)
VALUES ('Bed', 'King size');
INSERT INTO Equipment (equipmentName, equipment_description)
VALUES ('TV', '55 inch');
INSERT INTO Equipment (equipmentName, equipment_description)
VALUES ('Desk', 'Writing desk');
INSERT INTO Equipment (equipmentName, equipment_description)
VALUES ('Chair', 'Office chair');

-- Includes
INSERT INTO Includes (id_room, id_equip)
VALUES (1, 1);
INSERT INTO Includes (id_room, id_equip)
VALUES (1, 2);
INSERT INTO Includes (id_room, id_equip)
...
-- Assigned_to
INSERT INTO Assigned_to (id_serv, id_reser)
VALUES (1, 1);
INSERT INTO Assigned_to (id_serv, id_reser)
VALUES (2, 1);
INSERT INTO Assigned_to (id_serv, id_reser)
...
INNER JOIN Price_in_date P ON P.id_room_type=R.id_room_type
    AND P.dateFrom < TO_DATE('2024-02-01', 'YYYY-MM-DD') AND P.dateTo > TO_DATE('2024-04-01', 'YYYY-MM-DD');
...
WHERE Person.ID_PERSON IN (
    ...
    FROM Reservation
    WHERE Reservation.DATEFROM<=TO_DATE('2024-05-04', 'YYYY-MM-DD') AND Reservation.DATETO>=TO_DATE('2024-07-01', 'YYYY-MM-DD')
);

-- Procedures
create or replace procedure showAvailableRooms (
   p_roomtypetype  in varchar default null,
   p_guestcount    in varchar default null,
   p_datefrom      in date default sysdate,
   p_dateto        in date default null,
   p_priceconstant in varchar default null,
   p_equipmentname in varchar default null
    ...
    CURSOR availableRoomsCursor IS
        ...
        inner join Includes Inc on R.id_room = Inc.id_room
        inner join Equipment Eq on Eq.id_equip = Inc.id_equip
        WHERE (p_roomTypeType is null or Rt.roomTypeType = p_roomTypeType)
        and (p_guestCount IS NULL OR R.guestCount >= p_guestCount)
        and (p_dateFrom IS NULL OR P.dateTo >= p_dateFrom)
        AND (p_dateTo IS NULL OR P.dateFrom <= p_dateTo) -- Opravená podmienka pre dateTo
    ...
    v_dateFrom Price_in_date.dateFrom%TYPE;
    v_dateTo Price_in_date.dateTo%TYPE;
    ...
    noGuestCountAvailable EXCEPTION;
...
begin
    ...
    -- Kontroly na existenciu zadaných hodnôt v tabuľkách
    IF p_roomTypeType IS NOT NULL THEN
        SELECT COUNT(*) INTO v_count FROM Room_type WHERE roomTypeType = p_roomTypeType;
        IF v_count = 0 THEN
            RAISE noRoomTypeAvailable;
        END IF;
    END IF;

    IF p_guestCount IS NOT NULL THEN
        SELECT COUNT(*) INTO v_count FROM (SELECT DISTINCT guestCount FROM Room) WHERE guestCount = p_guestCount;
        IF v_count = 0 THEN
            RAISE noGuestCountAvailable;
        END IF;
    END IF;

    IF p_priceConstant IS NOT NULL THEN
        SELECT COUNT(*) INTO v_count FROM (SELECT DISTINCT priceConstant FROM Price_in_date)
        WHERE priceConstant = p_priceConstant;
        IF v_count = 0 THEN
            RAISE noPriceConstant;
        END IF;
    END IF;
    IF p_equipmentName IS NOT NULL THEN
        SELECT COUNT(*) INTO v_count FROM Equipment WHERE equipmentName = p_equipmentName;
        IF v_count = 0 THEN
    ...
    FETCH availableRoomsCursor INTO v_roomType, v_guestCount, v_dateFrom, v_dateTo, v_price, v_equipment;
    IF availableRoomsCursor%NOTFOUND THEN
        RAISE noAvailableRooms;
    END IF;
    CLOSE availableRoomsCursor;
    OPEN availableRoomsCursor; -- Opätovné otvorenie kurzora pre výpis

    -- Výpis hlavičky
    DBMS_OUTPUT.PUT_LINE(RPAD('Typ izby', 15) || RPAD('Ubytovaní', 10) || RPAD('Od', 12) || RPAD('Do', 12) || RPAD('Cena', 10) || 'Vybavenie');
    DBMS_OUTPUT.PUT_LINE(RPAD('----------', 15) || RPAD('----------', 10) || RPAD('----------', 12) || RPAD('----------', 12) || RPAD('----------', 10) || '----------');

    -- Prechádzanie výsledkov kurzora a ich výpis
    LOOP
        FETCH availableRoomsCursor INTO v_roomType, v_guestCount, v_dateFrom, v_dateTo, v_price, v_equipment;
        EXIT WHEN availableRoomsCursor%NOTFOUND;
        DBMS_OUTPUT.PUT_LINE(RPAD(v_roomType, 15) || RPAD(v_guestCount, 10) || RPAD(TO_CHAR(v_dateFrom, 'YYYY-MM-DD'), 12) || RPAD(TO_CHAR(v_dateTo, 'YYYY-MM-DD'), 12) || RPAD(v_price, 10) || v_equipment);
    END LOOP;
    ...
    EXCEPTION
    WHEN noRoomTypeAvailable THEN DBMS_OUTPUT.PUT_LINE('No room type available: ' || p_roomTypeType);
    WHEN noGuestCountAvailable THEN DBMS_OUTPUT.PUT_LINE('No rooms available for ' || p_guestCount || ' guests.');
    WHEN noDateFrom THEN DBMS_OUTPUT.PUT_LINE('Invalid start date: ' || TO_CHAR(p_dateFrom, 'YYYY-MM-DD'));
    WHEN noDateTo THEN DBMS_OUTPUT.PUT_LINE('Invalid end date: ' || TO_CHAR(p_dateTo, 'YYYY-MM-DD'));
    WHEN noPriceConstant THEN DBMS_OUTPUT.PUT_LINE('Invalid price: ' || p_priceConstant);
    WHEN noEquipmentNameAvailable THEN DBMS_OUTPUT.PUT_LINE('No equipment available: ' || p_equipmentName);
    WHEN noAvailableRooms THEN DBMS_OUTPUT.PUT_LINE('No available rooms matching the specified criteria.');
