...
begin
    ...
    LOOP
        ...
        DBMS_OUTPUT.PUT_LINE(RPAD(v_room_id, 8) || RPAD(v_roomType, 20) || RPAD(v_guestCount, 10) || RPAD(TO_CHAR(v_priceFrom, 'YYYY-MM-DD'), 12)
...
SET SERVEROUTPUT ON;
EXEC showAvailableRooms(p_roomTypeType => 'economy', p_guestCount => '4');
