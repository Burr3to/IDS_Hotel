...
-- Uistíme sa, že potenciálny index neexistuje
BEGIN
...
END;
/ -- <--- PL/SQL blok musí byť ukončený lomítkom na novom riadku
...
BEGIN -- <--- Začiatok PL/SQL bloku pre DBMS_OUTPUT
...
/ -- <--- Ukončenie CREATE INDEX lomítkom alebo bodkočiarkou
...
WHERE R.dateFrom >= TO_DATE('01/10/2024', 'DD/MM/YYYY')
  AND R.dateTo   <= TO_DATE('31/12/2024', 'DD/MM/YYYY')
  AND R.reservationStatus = 'Confirmed';
/ -- <--- Ukončenie EXPLAIN PLAN lomítkom
