...
-- Sekcia: Demonštrácia optimalizácie dotazu pomocou indexu a EXPLAIN PLAN
...
-- Cieľ: Na obhajobe vysvetliť rozdiel v pláne vykonania a ako index pomohol zrýchliť dotaz
--       (napr. zmena prístupu k tabuľke Reservation).
