...
SELECT
    ...
    CASE
        ...
        WHEN acs.TotalReservations >= 7 OR NVL(acs.TotalSpent, 0) >= 1800 THEN 'Gold Tier'
        WHEN acs.TotalReservations >= 15 OR NVL(acs.TotalSpent, 0) >= 2000 THEN 'Platinum Tier'
        WHEN acs.TotalReservations >= 8 OR NVL(acs.TotalSpent, 0) >= 3000 THEN 'Diamond Tier'
        WHEN acs.TotalReservations >= 10 OR NVL(acs.TotalSpent, 0) >= 5000 THEN 'Obsidian Tier'
