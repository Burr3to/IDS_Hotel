...
as
    cursor roomsWithEmployeesHistory is
        ...
        from Room R
        inner join Room_type Rt on R.id_room_type = Rt.id_room_type
        inner join PositionType Pos on Pos.id_posType = Per.id_posType
        inner join Person Per on Per.id_posType = Pos.id_posType
        inner join Managed_by M on M.id_person = Per.id_person
        where
